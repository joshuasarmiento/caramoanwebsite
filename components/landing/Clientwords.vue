  ...
  <Container>
    <div class="relative w-full client-words">
      ...
      >
        ...
        >
          <span class="font-island text-[4rem] text-[#FF9906]">Our Client Words</span>
        </h2>
        ...
        >
          <li v-for="item in items" :key="item">
            <div class="w-full h-full">
              <!-- Start Testimonial -->
              <div class="h-full overflow-hidden bg-white text-slate-500">
                <div class="relative p-6">
                  <figure class="relative z-10">
                    ...
                    <figcaption
                      class="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-[#FF9906]"
                    >
                      <div class="flex items-center gap-4 pt-4 text-sm text-[#FF9906]">
                        <!-- <img
                          :src="item.image"
                          :alt="item.name"
                          :title="item.name"
...
const items = [
  {
    ...
    text:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. A repellendus provident recusandae autem accusamus. Ab voluptas quidem expedita.",
