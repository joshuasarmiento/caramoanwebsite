    ...
    <Container>
        <div class="flex py-16 gap-6">
            <div class="w-[40%] flex flex-col items-start justify-center">
                <h2 class="flex flex-col gap-2 justify-center items-start uppercase font-semibold text-gray-600 mb-6">
                    <span class="text-2xl">Must Visit</span>
                    <span class=" font-island text-[2rem] font-semibold text-[#FF9906]">Beaches</span>
                </h2>
                <p class="text-black -mt-3 mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
